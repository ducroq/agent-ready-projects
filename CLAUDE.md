...
- **License**: MIT
- **agent-ready-projects** (this repo): v1.15.0 (skill scope is a framework decision; `.claude/skills/` tracked; `scripts/install-global-skills.sh`; measured `audit-context` Step 4 — 2026-08-06)
