...
│   └── fixtures/              <- Seeded-defect fixtures; refcheck.py is the Step 4 oracle
│       └── skill-template-sync/  <- Seeded drift for rule 6 (13 positives, 7 negatives)
