...
Skills that reference this repo's own paths (review-changes, release, and any project-specific skill) go project-local at .claude/skills/<name>/SKILL.md instead — see docs/GUIDE.md "Where a skill lives".
