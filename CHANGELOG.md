...
Worth recording for the versioning rationale: the evidence base for the Step 4 loosening is **one audit on one repo with zero true positives in the sample**. That measures specificity and cannot measure sensitivity at all. The change ships because the old check was concretely useless — 9 for 9 false — not because the new one is proven; the honest framing is in the step text.
