...
- **[GitHub spec-kit](https://github.com/github/spec-kit)** (73K+ stars) — Spec-Driven Development where specifications generate code. Addresses context through constitutions and template-driven LLM constraint. Solves a different problem (what to build) rather than how agents understand your project. See [COMPARISON.md](COMPARISON.md).
