# Cost and record discipline — history

History and measurements moved out of `docs/work-items/cost-and-record-discipline.md` on 2026-09-25 to keep the savepoint short.
...
- [x] ✅ **Step 3 (first half) — DONE 2026-09-14: the auto-loaded set cut 32%, 116,501 → 79,138 chars.**
  Everything from 2026-09-06 and earlier moved to `memory/archive/project_history_to_2026_09_06.md` (39,684 chars):
