...
| `test-verify-memory.md` | `.claude/skills/test-verify-memory/SKILL.md` | Ad-hoc prompt | Ad-hoc prompt | Ad-hoc prompt | Ad-hoc prompt | Ad-hoc prompt |
