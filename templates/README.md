...
| `review-changes.md` | `.claude/skills/review-changes/SKILL.md` | Pre-commit prompt | Pre-commit prompt | Pre-commit prompt | Pre-commit prompt | Pre-commit prompt |
| `release.md` | `.claude/skills/release/SKILL.md` | Release-time prompt | Release-time prompt | Release-time prompt | Release-time prompt | Release-time prompt |
